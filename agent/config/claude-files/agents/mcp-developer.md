...
- **Skills**: mcp-integration, architecture-patterns, nodejs-backend-patterns, error-handling-patterns, debugging-strategies
- **Plugin Skills**: everything-claude-code:api-design, everything-claude-code:backend-patterns, claude-api
- **MCP**: bumba-memory (reference implementation), bumba-sandbox, bumba-figma, github
- **Coordinate with**: ops-devops-specialist (deployment), engineering-api-engineer (protocol design), qa-api-tester (testing)
