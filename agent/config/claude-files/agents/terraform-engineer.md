...
- **Commands**: e2b/*, project/*
- **Skills**: git-advanced-workflows, github-actions-templates, distributed-tracing
- **Plugin Skills**: everything-claude-code:deployment-patterns, everything-claude-code:docker-patterns, everything-claude-code:enterprise-agent-ops
- **MCP**: cloudflare, digitalocean, kubernetes, docker-gateway
- **Coordinate with**: ops-cloud-architect (cloud strategy), ops-kubernetes-engineer (container orchestration), ops-sre-engineer (reliability)
