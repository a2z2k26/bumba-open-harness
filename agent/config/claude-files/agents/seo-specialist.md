...
- **Commands**: orc/*
- **Skills**: company-research, customer-journey-map, product-strategy-session, business-health-diagnostic
- **Plugin Skills**: everything-claude-code:market-research, everything-claude-code:content-engine, everything-claude-code:article-writing, Notion:search, Notion:create-page
- **MCP**: notion, brave-search, exa, context7
- **Coordinate with**: strategy-market-researcher (market analysis), strategy-competitive-intelligence-analyst (competitor SEO), engineering-frontend-developer (technical SEO implementation)
