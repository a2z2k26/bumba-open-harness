...
- **Skills**: sql-optimization-patterns, async-python-patterns, python-packaging, architecture-patterns
- **Plugin Skills**: everything-claude-code:python-patterns, everything-claude-code:database-migrations, everything-claude-code:postgres-patterns, everything-claude-code:python-review
- **MCP**: postgres, supabase, mongodb, pinecone, qdrant, chroma, bumba-memory
- **Coordinate with**: engineering-database-specialist (schema design), ai-engineer (ML pipelines), engineering-performance-engineer (optimization)
