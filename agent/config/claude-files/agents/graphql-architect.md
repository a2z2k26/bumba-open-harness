...
- **Skills**: architecture-patterns, error-handling-patterns, nodejs-backend-patterns, sql-optimization-patterns
- **Plugin Skills**: everything-claude-code:api-design, everything-claude-code:backend-patterns, everything-claude-code:coding-standards
- **MCP**: postgres, supabase, mongodb, github
- **Coordinate with**: engineering-api-engineer (API design), engineering-database-specialist (data layer), engineering-frontend-developer (client integration)
