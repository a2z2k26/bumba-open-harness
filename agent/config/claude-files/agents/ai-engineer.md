...
- **Skills**: architecture-patterns, async-python-patterns, python-packaging, rag-implementation, langchain-architecture, prompt-engineering-patterns
- **Plugin Skills**: everything-claude-code:python-patterns, everything-claude-code:python-review, everything-claude-code:python-testing, claude-api
- **MCP**: pinecone, qdrant, chroma, bumba-memory, supabase, postgres
- **Coordinate with**: llm-architect (architecture), prompt-engineer (prompts), data-engineer (data pipelines)
