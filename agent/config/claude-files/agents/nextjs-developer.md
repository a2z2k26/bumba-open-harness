...
- **Commands**: code/execute, gh/*, design-layout-to-jsx, design-layout-to-tailwind, design-transform-react
- **Skills**: react-modernization, architecture-patterns, frontend-design, stripe-integration
- **Plugin Skills**: everything-claude-code:frontend-patterns, feature-dev:feature-dev, figma:implement-design
- **MCP**: shadcn, magic-ui, figma-context, supabase, github
- **Coordinate with**: react-specialist (components), design-ui-designer (design specs), engineering-api-engineer (API integration)
