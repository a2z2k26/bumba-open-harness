...
- **Commands**: design-layout-to-swiftui, design-transform-swiftui, code/execute
- **Skills**: transform-swiftui, frontend-design, architecture-patterns
- **Plugin Skills**: figma:implement-design, figma:code-connect-components, everything-claude-code:swift-concurrency-6-2, everything-claude-code:swiftui-patterns
- **MCP**: figma-context, mcp-figma, bumba-figma
- **Coordinate with**: design-ui-designer (design specs), design-system-architect (design tokens), qa-mobile-tester (testing)
