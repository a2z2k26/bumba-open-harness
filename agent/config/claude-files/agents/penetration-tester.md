...
- **Plugin Skills**: everything-claude-code:security-scan, everything-claude-code:security-review, superpowers:verification-before-completion
- **MCP**: playwright, chrome-devtools
- **Coordinate with**: qa-security-auditor (security policy), engineering-backend-architect (architecture review), ops-network-engineer (network security)
