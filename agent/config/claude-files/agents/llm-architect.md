...
- **Skills**: architecture-patterns, rag-implementation, langchain-architecture, prompt-engineering-patterns, async-python-patterns, fastapi-templates
- **Plugin Skills**: everything-claude-code:python-patterns, everything-claude-code:api-design, claude-api
- **MCP**: pinecone, qdrant, chroma, bumba-memory, context7
- **Coordinate with**: ai-engineer (implementation), prompt-engineer (prompt design), engineering-performance-engineer (optimization)
