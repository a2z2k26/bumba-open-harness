...
- **Commands**: code/execute, project/*
- **Skills**: command-development, hook-development, skill-authoring-workflow, nodejs-backend-patterns, python-packaging, uv-package-manager
- **Plugin Skills**: everything-claude-code:coding-standards, everything-claude-code:python-patterns
- **MCP**: filesystem, github
- **Coordinate with**: mcp-developer (MCP integration), engineering-api-engineer (API design), ops-devops-specialist (distribution)
