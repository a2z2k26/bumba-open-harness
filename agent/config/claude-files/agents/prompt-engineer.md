...
- **Skills**: prompt-engineering-patterns, prompt-improver, context-engineering-advisor, rag-implementation
- **Plugin Skills**: claude-api, everything-claude-code:python-patterns
- **MCP**: context7, bumba-memory, pinecone, qdrant
- **Coordinate with**: llm-architect (system design), ai-engineer (implementation), engineering-api-engineer (API integration)
