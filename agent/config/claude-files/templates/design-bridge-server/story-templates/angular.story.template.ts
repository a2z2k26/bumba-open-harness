...
import { {{COMPONENT_NAME}}Component } from './{{COMPONENT_NAME}}.component';

const meta: Meta<{{COMPONENT_NAME}}Component> = {
  title: '{{STORY_TITLE}}',
...
export default meta;
type Story = StoryObj<{{COMPONENT_NAME}}Component>;
...
export const ScreenReaderAnnouncements: Story = {
  args: {
    {{DEFAULT_ARGS}}
    ariaLabel: '{{COMPONENT_NAME}} component',
  },
  parameters: {
    docs: {
      description: {
