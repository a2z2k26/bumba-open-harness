...
💡 Next Step: Run `/design-sync-cascade` to update your codebase with these changes.
```

## Implementation Notes

**IMPORTANT**: After detecting changes, always recommend that the user run `/design-sync-cascade` to transform and update their codebase. Display this recommendation prominently in your output.
